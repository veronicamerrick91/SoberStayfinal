...
import { SoberLivingCity } from "@/pages/sober-living-city";
import { FindSoberLiving } from "@/pages/find-sober-living";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route path="/find-sober-living" component={FindSoberLiving} />
