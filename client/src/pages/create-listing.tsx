      ...
      <Layout>
        <div className="min-h-screen bg-background py-8">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">Review Your Listing</h1>
              <p className="text-muted-foreground">Check how your property will appear to tenants before publishing.</p>
            </div>
          ...
          <form className="space-y-8">
            ...
            <div className="flex gap-3 justify-end pt-4">
              <Button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 gap-2"
                data-testid="button-review-listing"
              >
                <CheckCircle className="w-4 h-4" />
                Review & Publish
              </Button>
